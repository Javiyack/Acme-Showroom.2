...
<a class="w3-button w3-hover-dark-grey" style="position:absolute;top:45%;left:0;" onclick="plusDivs(-1)"><i class="fa fa-angle-right" ></i> </a>
<a class="w3-button w3-hover-dark-grey" style="position:absolute;top:45%;right:0;" onclick="plusDivs(+1)"><i class="fa fa-angle-left" ></i></a>
</div>
